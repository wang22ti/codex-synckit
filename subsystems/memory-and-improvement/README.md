...
For the compact canonical maintainer policy reference, see [references/maintainer-reference.md](references/maintainer-reference.md). This README stays summary-first on purpose.
